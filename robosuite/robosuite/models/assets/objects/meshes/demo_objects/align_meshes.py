...
def rotate_meshes(og_mesh_filename, new_mesh_filename, output_path):
  ...
  def planar_direction(mesh):
    ...
    handle_mask = (radial_distances > mean_radius + 1.5 * radius_std) & height_mask & (vertices[:, 0] > 0)
  ...
  def scale_mesh_to_match_bounding_box(mesh1, mesh2):
    ...
    # print(f"Ref Mesh Max Height: {mesh2.bounding_box.bounds[1][1] - mesh2.bounding_box.bounds[0][1]}")
    # print(f"Prop Mesh Max Height: {mesh1.bounding_box.bounds[1][1] - mesh1.bounding_box.bounds[0][1]}")
  ...
  print(np.argmax(new_mesh.vertices[:, 1]))
  ...
  # print(f"Prop Mesh Max Height: {new_mesh.bounding_box.bounds[1][1] - new_mesh.bounding_box.bounds[0][1]}")

  new_mesh.export(output_path + 'Rotated.obj', file_type='obj')
  # new_mesh.export(output_path + 'Rotated.obj', file_type='obj', mtl_name = output_path + 'Rotated.mtl')
  

if __name__ == '__main__':
  rotate_meshes('mug', '0a2aa28dd0924f6a80e73d2fb7fb1a50', 'aligned/')