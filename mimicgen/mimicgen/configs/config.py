...
def config_factory(name, config_type, dic=None):
    ...
    """
    print('config type not in registered configs', config_type not in REGISTERED_CONFIGS)
    print('name not in registered configs', name not in REGISTERED_CONFIGS[config_type])
    print('config type', config_type)
    print('name', name)
    print("registeredconfigs[config_type]", REGISTERED_CONFIGS[config_type])
