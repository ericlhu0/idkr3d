...
def generate_dataset(
    ...
    while True:
        ...
        if True:
            # Load the XML file
            xml_file = "/Users/eric/Documents/r3d/robosuite/robosuite/models/assets/objects/kettle.xml"  # Replace with the path to your XML file
            tree = ET.parse(xml_file)
            root = tree.getroot()

            # Define the new mesh file path
            new_mesh = random.choice([("meshes/generated_objs/kettle.obj", 0.2), 
                                      ("meshes/generated_objs/pitcher.obj", 0.2), 
                                      ("meshes/mug.obj", 0.6)])
            ...
            updated_xml_file = "/Users/eric/Documents/r3d/robosuite/robosuite/models/assets/objects/kettle.xml"  # Replace with your desired output file name
