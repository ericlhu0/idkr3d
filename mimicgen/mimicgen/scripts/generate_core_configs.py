...
CAMERA_NAMES = ["agentview", "robot0_eye_in_hand", "Milk_kettle_camera"]
CAMERA_SIZE = (84, 84)
...
BASE_CONFIGS = [
    ...
    os.path.join(BASE_BASE_CONFIG_PATH, "pick_place_mug.json"),
]
...
def make_generators(base_configs):
    ...
    all_settings = [
        ...
        # pick_place_mug
        dict(
            dataset_path=os.path.join(SRC_DATA_DIR, "pick_place_mug.hdf5"),
            dataset_name="pick_place_mug",
            generation_path="{}/pick_place_mug".format(OUTPUT_FOLDER),
            # task_interface="MG_PickPlace",
            tasks=["PickPlaceMug"],
            task_names=["base"],
            select_src_per_subtask=True,
