...
try:
    ...
    from mimicgen.envs.robosuite.pick_place_mug import *
except ImportError as e:
...
def register_all_links():
    ...
    dataset_infos = [
        ...
        ("pick_place_mug", 1000, "source/pick_place_mug.hdf5"),
    ]
    ...
    dataset_infos = [
        ...
        ("pick_place_mug", 1000, "core/pick_place_mug.hdf5"),
    ]
    for task, horizon, link in dataset_infos:
        register_dataset_link(
            dataset_type=dataset_type,
    ...
    dataset_infos = [
        ...
        ("pick_place_mug", 1400, "large_interpolation/pick_place_mug.hdf5"),
    ]
    for task, horizon, link in dataset_infos:
        register_dataset_link(
            dataset_type=dataset_type,
